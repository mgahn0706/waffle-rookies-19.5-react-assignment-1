...
const Login = () => {
  ...
  return (
    <div className="loginWrapper">
      ...
      <div className="signInTitle">Sign in to WaffleHighSchool</div>
      <div className="loginBox">
        <div className="usernameText">Username or email address</div>
        <input
      ...
      <div className="signUpBox">
        ...
        <span className="createAccountLink" onClick={() => handleNotUpdated()}>
          Create an account.
        </span>
      </div>
